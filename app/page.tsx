        ...
        <Tabs defaultValue="overview" className="space-y-4">
          ...
          <TabsContent value="cameras" className="space-y-4">
            <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
              <Card>
                <CardHeader>
                  <CardTitle>Camera 1 - Main View</CardTitle>
                </CardHeader>
                <CardContent>
                  <div className="aspect-video overflow-hidden rounded-md bg-muted">
                    <CameraFeed cameraId="camera1" />
                  </div>
                </CardContent>
              </Card>
              <Card>
                <CardHeader>
                  <CardTitle>Camera 2 - Nutrient Tank</CardTitle>
                </CardHeader>
                <CardContent>
                  <div className="aspect-video overflow-hidden rounded-md bg-muted">
                    <CameraFeed cameraId="camera2" />
                  </div>
                </CardContent>
              </Card>
              <Card>
                <CardHeader>
                  <CardTitle>Camera 3 - Growth Bed</CardTitle>
                </CardHeader>
                <CardContent>
                  <div className="aspect-video overflow-hidden rounded-md bg-muted">
                    <CameraFeed cameraId="camera3" />
                  </div>
                </CardContent>
              </Card>
            </div>
